# create_user.py (VERSÃO CORRIGIDA E FINAL)
...
# Tabela de Pedidos foi simplificada
...
def criar_tudo():
    with app.app_context():
        print("Criando todas as tabelas do banco de dados (versão final)...")
        db.create_all()
